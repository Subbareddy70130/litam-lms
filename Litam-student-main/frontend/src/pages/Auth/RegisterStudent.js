...
import { 
    ...
    Calendar, UserPlus, ArrowRight, AlertCircle, Sparkles 
} from 'lucide-react';
...
const RegisterStudent = () => {
    const [data, setData] = useState({ 
        ...
        roll_number: '', department: '', year: 2026 
    });
        ...
        try {
            ...
            if (err.code === 'ERR_NETWORK') {
                ...
                const errors = Object.entries(err.response.data)
                    ...
                    .join('\n');
                setMessage(errors || 'Registration failed. Please check your input.');
            } else {
        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '32px' }}>
                    ...
                    <h2 style={{ fontSize: '1.75rem', fontWeight: 700, color: 'white' }}>Student Registration</h2>
                    <p style={{ color: 'rgba(255, 255, 255, 0.5)', marginTop: '8px' }}>Join the LITAM academic community</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                    <div style={{ gridColumn: 'span 1' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input type="text" name="username" value={data.username} onChange={handleChange} placeholder="johndoe" style={inputStyle} required />
                        </div>
                    </div>
                    ...
                    <div style={{ gridColumn: 'span 2' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input type="email" name="email" value={data.email} onChange={handleChange} placeholder="student@college.edu" style={inputStyle} required />
                        </div>
                    </div>
                    ...
                    <div style={{ gridColumn: 'span 1' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input type="text" name="roll_number" value={data.roll_number} onChange={handleChange} placeholder="22A41A05XX" style={inputStyle} required />
                        </div>
                    </div>
                    ...
                    <div style={{ gridColumn: 'span 2' }}>
                        <label style={labelStyle}>Year of Graduation</label>
                        <div style={{ position: 'relative' }}>
                            <Calendar size={18} style={iconStyle} />
                            <input type="number" name="year" value={data.year} onChange={handleChange} placeholder="2026" style={inputStyle} required />
                        </div>
                    </div>
